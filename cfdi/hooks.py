...
fixtures = [
    ...
    {"dt":"Custom Field", "filters": [ ["dt", "in", ("Sales Invoice","CFDI Nota de Credito","Payment Entry","Payment Entry Reference")],["modified", ">", ("2020-01-01")] ]},
    {"dt":"Property Setter", "filters": [["doc_type", "in", ("Sales Invoice","CFDI Nota de Credito","Payment Entry","Payment Entry Reference")],["modified", ">", ("2020-01-01")] ]},
]
...
doc_events = {
	"Payment Entry": {
		"on_submit": "cfdi.cfdi.doctype.cfdi.cfdi.parcialidades_pe"
	}
}
